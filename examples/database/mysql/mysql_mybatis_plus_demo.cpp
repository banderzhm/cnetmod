...
auto main() -> int
{
    ...
    auto work = [&]() -> task<void>
    {
        ...
        mysql_base_mapper<User> user_mapper(cli);
        ...
        // Or use string enum
        global_enum_registry().register_string_enum<UserStatus>({{UserStatus::INACTIVE, "inactive"},
