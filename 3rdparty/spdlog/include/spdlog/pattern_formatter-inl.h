...
inline std::array<const char *, 7> days{{"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"}};
...
// Full weekday name
inline std::array<const char *, 7> full_days{
...
// Abbreviated month
inline const std::array<const char *, 12> months{
...
// Full month name
inline const std::array<const char *, 12> full_months{{"January", "February", "March", "April",
