...
macro(cnetmod_configure_openssl)
    ...
    if(CNETMOD_ENABLE_SSL AND CNETMOD_USE_BORINGSSL_SUBMODULE AND BoringSSL_FOUND)
        set(CNETMOD_HAS_SSL ON)
        message(STATUS "Using bundled BoringSSL - skipping system OpenSSL")
    elseif(CNETMOD_ENABLE_SSL AND NOT CNETMOD_USE_BORINGSSL_SUBMODULE)
    ...
    elseif(CNETMOD_ENABLE_SSL AND CNETMOD_USE_BORINGSSL_SUBMODULE)
        # The bundled provider has already been configured. Do not mix its
        # OpenSSL-compatible symbols with a system OpenSSL installation.
        message(STATUS "Using bundled BoringSSL - skipping system OpenSSL")
        set(CNETMOD_HAS_SSL OFF)
    endif()
endmacro()
