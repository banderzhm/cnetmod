...
public:
    ip_address() noexcept
        : v4_{}, family_(address_family::ipv4) {}

    ip_address(ipv4_address addr) noexcept
        : v4_(addr), family_(address_family::ipv4) {}

    ip_address(ipv6_address addr) noexcept
        : v6_(addr), family_(address_family::ipv6) {}
    ...
    [[nodiscard]] auto to_v4() const -> const ipv4_address&
    {
        return v4_;
    }

    [[nodiscard]] auto to_v6() const -> const ipv6_address&
    {
        return v6_;
    }
...
public:
    ...
    void set_port(std::uint16_t p) noexcept;
