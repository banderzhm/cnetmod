# cnetmod Documentation

[English](en/README.md) | [中文](zh/README.md)

---

Welcome to the cnetmod documentation! Choose your language:
...
- Protocol guides (HTTP, WebSocket, MQTT, Kafka, AMQP 0-9-1, AMQP 1.0, MySQL, PostgreSQL, MongoDB, Redis, Raft)
...
- 安装和快速开始
- 核心概念（协程、I/O、同步）
- 协议指南（HTTP、WebSocket、MQTT、Kafka、AMQP 0-9-1、AMQP 1.0、MySQL、PostgreSQL、MongoDB、Redis、Raft）
...
- [Quick Start](en/getting-started.md)
- [Architecture Overview](en/architecture.md)
- [Examples](en/examples.md)
- [Raft](en/protocols/raft.md)
- [Third-party Dependency Integration](en/advanced/thirdparty-dependency-integration.md)
...
- [示例](zh/examples.md)
- [Raft](zh/protocols/raft.md)
- [第三方依赖集成](zh/advanced/thirdparty-dependency-integration.md)
