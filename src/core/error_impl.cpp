...
auto network_error_category::name() const noexcept -> const char*
{
    return "cnetmod";
}
...
auto network_error_category::message(int ev) const -> std::string
{
    ...
    case errc::connection_timed_out:
...
auto from_native_error([[maybe_unused]] int native_error) noexcept -> errc
{
    ...
    case WSAETIMEDOUT:
        return errc::connection_timed_out;
    case WSAENOTCONN:
    ...
    case WSA_OPERATION_ABORTED:
        return errc::operation_aborted; // == ERROR_OPERATION_ABORTED (995)
    case WSAEINPROGRESS:
