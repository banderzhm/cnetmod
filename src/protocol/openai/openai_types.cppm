...
export struct transcription_request {
  ...
  std::string response_format =
      "json";               // "json"|"text"|"srt"|"vtt"|"verbose_json"
...
export struct image_generation_request {
  ...
  std::string size =
      "1024x1024"; // "256x256"|"512x512"|"1024x1024"|"1792x1024"|"1024x1792"
...
export struct moderation_request {
  std::string model = "text-moderation-latest"; // "text-moderation-latest" |
