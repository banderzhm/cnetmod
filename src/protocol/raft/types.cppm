...
namespace cnetmod::raft
{
    ...
    export constexpr auto role_name(node_role role) noexcept -> std::string_view
    {
        switch (role)
        {
        case node_role::follower: return "follower";
        case node_role::pre_candidate: return "pre_candidate";
        case node_role::candidate: return "candidate";
        case node_role::leader: return "leader";
        }
        return "unknown";
    }
    ...
    export struct raft_error
    {
        ...
        [[nodiscard]] auto ok() const noexcept -> bool { return code == raft_errc::ok; }
    };
