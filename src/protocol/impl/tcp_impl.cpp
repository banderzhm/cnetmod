...
acceptor::acceptor(io_context& ctx)
    : ctx_(&ctx) {}
...
auto acceptor::is_open() const noexcept -> bool
{
    return socket_.is_open();
}

auto acceptor::native_socket() noexcept -> socket&
{
    return socket_;
}

auto acceptor::context() noexcept -> io_context&
{
    return *ctx_;
}
...
auto connection::native_socket() noexcept -> socket&
{
    return socket_;
}

auto connection::context() noexcept -> io_context&
{
    return *ctx_;
}
