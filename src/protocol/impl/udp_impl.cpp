...
void udp_socket::close() noexcept { socket_.close(); }

auto udp_socket::is_open() const noexcept -> bool { return socket_.is_open(); }

auto udp_socket::native_socket() noexcept -> socket & { return socket_; }

auto udp_socket::context() noexcept -> io_context & { return *ctx_; }
