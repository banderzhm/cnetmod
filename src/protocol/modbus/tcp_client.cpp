...
{
public:
    explicit tcp_client_impl(io_context& ctx)
...
tcp_client::tcp_client(io_context& ctx)
...
auto tcp_client::is_open() const -> bool
{
...
auto tcp_client::get_port() const -> std::uint16_t
{
