...
auto metrics_collector::serialize() const -> std::string
{
    ...
    out += std::format("# HELP cnetmod_http_response_bytes_total Total response " "body bytes.\n# TYPE cnetmod_http_response_bytes_total " "counter\ncnetmod_http_response_bytes_total {}\n",
