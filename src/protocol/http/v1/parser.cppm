...
namespace cnetmod::http
{
    ...
    public:
        ...
        [[nodiscard]] auto consume(const char*, std::size_t) -> std::expected<std::size_t, std::error_code>;
    ...
    private:
        ...
        auto parse_request_line(std::string_view) -> std::expected<void, std::error_code>;
        auto parse_header_line(std::string_view) -> std::expected<void, std::error_code>;
    ...
    private:
        ...
        auto parse_status_line(std::string_view) -> std::expected<void, std::error_code>;
        auto parse_header_line(std::string_view) -> std::expected<void, std::error_code>;
        auto prepare_body() -> bool;
        auto process_chunked_body() -> std::expected<bool, std::error_code>;
