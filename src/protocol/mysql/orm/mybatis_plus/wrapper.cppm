...
namespace detail {
    inline auto to_param_value(std::int64_t v) -> param_value
    {
        return param_value::from_int(v);
    }

    inline auto to_param_value(std::uint64_t v) -> param_value
    {
        return param_value::from_uint(v);
    }

    inline auto to_param_value(int v) -> param_value
    {
        return param_value::from_int(v);
    }

    inline auto to_param_value(std::uint32_t v) -> param_value
    {
        return param_value::from_uint(v);
    }

    inline auto to_param_value(double v) -> param_value
    {
        return param_value::from_double(v);
    }

    inline auto to_param_value(float v) -> param_value
    {
        return param_value::from_double(v);
    }

    inline auto to_param_value(const std::string& v) -> param_value
    {
        return param_value::from_string(v);
    }

    inline auto to_param_value(std::string_view v) -> param_value
    {
        return param_value::from_string(std::string(v));
    }

    inline auto to_param_value(const char* v) -> param_value
    {
        return param_value::from_string(std::string(v));
    }

    inline auto to_param_value(bool v) -> param_value
    {
        return param_value::from_int(v ? 1 : 0);
    }

    inline auto to_param_value(const mysql_date& v) -> param_value
    {
        return param_value::from_date(v);
    }

    inline auto to_param_value(const mysql_datetime& v) -> param_value
    {
        return param_value::from_datetime(v);
    }

    inline auto to_param_value(const mysql_time& v) -> param_value
    {
