...
transaction_guard::transaction_guard(client &cli) noexcept : cli_(&cli) {}
...
auto transaction_guard::is_committed() const noexcept -> bool {
  return committed_;
}
...
auto transaction::begin(client &cli)
